...
public:
    ...
    SIPLeaderboard *GetLeaderboard() {return &this->leaderboard;}
...
public:
    ...
    SIPLeaderboard leaderboard __attribute((aligned (0x20))); //aligned for file operations
    TimeEntry entry;
    u32 mainGhostIndex; //from the watch replay;
    u32 selGhostsIndex[3];
    u32 lastUsedSlot;
    SIP::FolderHandler *folder;
