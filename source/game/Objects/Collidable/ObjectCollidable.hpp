...
class ObjectCollidable : public Object{ //collision is added as there is no KCL, different shapes available cube/cylinder/sphere, depends on the obj
    ...
    virtual void BeforeKartCollision(Kart *kart, ObjToKartInteraction *objToKart, KartToObjInteraction *kartToObj); //0xb8 8081f66c
    ...
    virtual ObjToKartInteraction OnCollision(Kart *kart, ObjToKartInteraction default, KartToObjInteraction kartToObj) const; //0xc0 8068179c
