...
class Wanwan_Chn : public ObjectCollidable{
    ...
    virtual ObjToKartInteraction OnCollision(Kart *kart, ObjToKartInteraction default, KartToObjInteraction kartToObj) const; //0xc0 806e4218
...
class Wanwan : public ObjectCollidable, public ObjectCycleManager{
    ...
    virtual ObjToKartInteraction OnCollision(Kart *kart, ObjToKartInteraction default, KartToObjInteraction kartToObj) const; //0xc0 806e526c
