...
class SIPLeaderboard {
public:
    SIPLeaderboard();
    SIPLeaderboard(const char *folderPath, u32 crc32);
    ...
    void AddTrophy(){this->hasTrophy[SIP::ttMode] = true;}
    const SIPTimeEntry &GetEntry(EntryLaps lap) const {return this->entries[SIP::ttMode][lap];}
...
private:
    ...
    bool hasTrophy[4];
    u32 reserved[8];
    SIPTimeEntry entries[4][11]; //0x30 to 0x44C 11th = flap
...
SIPTimeEntry *GetSIPTimeEntry(u32 index);
#endif